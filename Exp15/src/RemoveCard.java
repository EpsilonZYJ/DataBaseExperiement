...
public class RemoveCard {
    ...
    private static final String REMOVE_CARD_QUERY = "DELETE FROM bank_card WHERE b_c_id=? AND b_number=?;";
    /**
     * 删除bank_card表中数据
     *
    ...
    public static int removeBankCard(Connection connection,
        ...
        int success_num = 0;
        try{
            PreparedStatement ppStatement = connection.prepareStatement(REMOVE_CARD_QUERY);
            ppStatement.setInt(1, b_c_id);
            ppStatement.setString(2, b_number);
